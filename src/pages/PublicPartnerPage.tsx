    ...
    <div className="min-h-screen" style={{ background: bg }} dir="rtl">
      ...
      <div className="max-w-lg mx-auto px-6 pb-10">
        <div className="grid grid-cols-2 gap-3">
          {STATS.map(s => (
            <div key={s.label} className="bg-white rounded-3xl p-5 shadow-sm text-center space-y-1">
      ...
      <div className="max-w-lg mx-auto px-6 pb-10 space-y-4">
        ...
        {HOW_IT_WORKS.map(step => (
          <div key={step.step} className="bg-white rounded-3xl p-5 shadow-sm flex gap-4 items-start">
        ...
        <div className="bg-white rounded-3xl p-6 shadow-sm space-y-4">
          ...
          <div className="rounded-2xl overflow-hidden border border-gray-100">
            ...
            <div className="p-4" style={{ background: '#ECE5DD' }}>
              <div className="bg-white rounded-2xl rounded-tr-sm px-4 py-3 shadow-sm max-w-[85%] mr-auto">
      ...
      <div className="max-w-lg mx-auto px-6 pb-10 space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          {CATEGORIES.map(c => (
            <div key={c.label} className="bg-white rounded-2xl px-4 py-3.5 shadow-sm flex items-center gap-3">
      ...
      <div className="max-w-lg mx-auto px-6 pb-10 space-y-4">
        ...
        {TESTIMONIALS.map(t => (
          <div key={t.name} className="bg-white rounded-3xl p-5 shadow-sm space-y-3">
