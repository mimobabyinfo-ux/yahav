        ...
        <div className="pt-2 flex items-center justify-between">
          ...
          {profileComplete && !editMode && (
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-2 bg-[#DCD4C8] rounded-2xl text-xs font-semibold text-sand-500 shadow-sm hover:text-sand-700 transition-colors"
            >
          ...
          filteredPregnant.length === 0 ? (
            ...
            <div className="space-y-3">
              ...
              {filteredPregnant.map(p => {
                ...
                return (
                  <div key={p.id} className="bg-[#DCD4C8] rounded-3xl p-4 shadow-sm">
        ...
        {!isPregnant && (
          filteredMoms.length === 0 ? (
            ...
            <div className="space-y-3">
              ...
              {filteredMoms.map(p => (
                <div key={p.child_id} className="bg-[#DCD4C8] rounded-3xl p-4 shadow-sm">
                  <div className="flex items-start gap-3">
