              ...
              {videos.length > 0 && (
                <section>
                  ...
                  <div className="space-y-3">
                    {videos.map(item => (
                      <div key={item.id} className="bg-[#DCD4C8] rounded-2xl overflow-hidden shadow-sm">
                        {item.url && (
                ...
                <section>
                  ...
                  <div className="space-y-3">
                    {homework.map(item => {
                      ...
                      return (
                        <div key={item.id} className="bg-[#DCD4C8] rounded-2xl shadow-sm overflow-hidden">
                  ...
                  <div className="space-y-2">
                    {pdfs.map(item => (
                      <a key={item.id} href={item.url ?? '#'} target="_blank" rel="noopener noreferrer"
                        className="flex items-center gap-3 bg-[#DCD4C8] rounded-2xl p-4 shadow-sm hover:bg-sand-50 transition-colors">
            ...
            {activeWorkshops.map(aw => {
              ...
              return (
                <button key={aw.id} onClick={() => openWorkshop(aw)}
                  className="w-full bg-[#DCD4C8] rounded-3xl shadow-sm overflow-hidden hover:shadow-md hover:-translate-y-0.5 transition-all text-right">
                  {w?.image_url ? (
