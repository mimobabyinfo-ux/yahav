    ...
    <div className="min-h-screen flex flex-col justify-center p-6 pb-10" style={{ background: '#FFFFFF' }} dir="rtl">
      <div className="w-full max-w-sm mx-auto space-y-5">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          {/* Mode selector */}
          <div className="bg-[#F5F5F5] rounded-3xl shadow-sm p-4">
          ...
          {/* Mother details */}
          <div className="bg-[#F5F5F5] rounded-3xl shadow-sm p-5 space-y-4">
            {/* Name — split */}
            <div className="flex gap-2">
          ...
          {mode === 'pregnant' && (
            <div className="bg-[#F5F5F5] rounded-3xl shadow-sm p-5 overflow-hidden">
          ...
          {mode === 'mom' && babies.map((baby, idx) => (
            <div key={idx} className="bg-[#F5F5F5] rounded-3xl shadow-sm p-5 space-y-4">
