-- Same-day registration closes: the public cohorts RPC now returns only
-- cohorts starting FROM TOMORROW (Asia/Jerusalem). A cohort on 15.07 stops
-- being offered at 00:00 on 15.07 — matching the landing page behavior.
